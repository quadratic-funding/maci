...
#npx hardhat node --port 8545 --fork https://rpc.xdaichain.com/ --fork-block-number 14827285
npx hardhat node --port 8545 --fork https://xdai-archive.blockscout.com --fork-block-number 14827285
